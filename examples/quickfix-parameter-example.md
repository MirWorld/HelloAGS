...
1. 按 `references/quickfix-protocol.md` 创建最小完整方案包：
   - `helloagents/plan/YYYYMMDDHHMM_quickfix_auth-timeout/why.md`
   - `helloagents/plan/YYYYMMDDHHMM_quickfix_auth-timeout/how.md`
   - `helloagents/plan/YYYYMMDDHHMM_quickfix_auth-timeout/task.md`
